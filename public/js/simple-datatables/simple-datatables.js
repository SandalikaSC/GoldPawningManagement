					...
					const dataToTable = function (t) {
						...
						defaultConfig = {
							...
							labels: {
								placeholder: "Search...",
								perPage: "{select}",
								noRows: "Item not found",
								info: "Exhibits  {start} to  {end} of  {rows} items",
							},
							layout: {
								top: "{select}{search}",
								bottom: "{info}{pager}",
					...
					class DataTable {
						...
						render(t) {
							...
							if (
								...
								(t += e.labels.perPage),
									(t += "<label>Items per page</label></div>");
							...
							if (e.searchable) {
								const t = `<div class='div-top'> <div class='dataTable-search div-search_table'><input class='dataTable-input' placeholder='${e.labels.placeholder}' type='text'></div> </div>`;
