            ...
            <div class="inside-page">
                ...
                <div class="card-set">
                    <div class="lc-card">
                        ...
                        <div class="lc-img">
                            <a href="<?php echo URLROOT ?>/mgLocker/viewLockerItems"><img class="nonstatic-img" src="<?php echo URLROOT ?>/img/lockerGIF.gif" alt="locker" /></a>
                            <img class="static-img" src="<?php echo URLROOT ?>/img/locker200.png" alt="locker" />
                        </div>
                    ...
                    <div class="lc-card">
                        ...
                        <div class="lc-img">
                            <a href="<?php echo URLROOT ?>/mgLocker/viewLockerItems"><img class="nonstatic-img" src="<?php echo URLROOT ?>/img/lockerGIF.gif" alt="" /></a>
                            <img class="static-img" src="<?php echo URLROOT ?>/img/locker200.png" alt="" />
                        </div>
                        <div class="down-arrow">
                            <a class="toggle-button">
                                <img src="<?php echo URLROOT ?>/img/downArrow.png" />
