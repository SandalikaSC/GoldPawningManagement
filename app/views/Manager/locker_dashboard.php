                            ...
                            <section class="lc-card">
                                ...
                                <div class="lc-img">
                                    <?php if ($row->No_of_Articles == 0) { ?>
                                        <a href="#"><img class="nonstatic-img" src="<?php echo URLROOT ?>/img/lockerGIF.gif" alt="locker" /></a>
                                    <?php } else { ?>
                                        <a href="<?php echo URLROOT ?>/mgLocker/viewLockerItems/<?php echo $row->lockerNo ?>"><img class="nonstatic-img" src="<?php echo URLROOT ?>/img/lockerGIF.gif" alt="locker" /></a>
                                    <?php } ?>
