    ...
    <section class="side-message" id="message-main">
        <div class="message-content" id="message-content">
            <button type="button" class="message-cont-btn" id="close-btn">
                <img style="width: 25px;margin-top: 5px;" src="<?php echo URLROOT ?>/img/check-mark.png" alt="">
            </button>
            <div class="message-cont-text" style="color:#169E04;" id="right-alert-text">
