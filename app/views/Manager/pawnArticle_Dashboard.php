                                    ...
                                    echo "
                                            <tr>
                                                       ...
                                                       <td><img src=" . $row->image . " ></td>
                                                        ...
                                                        <td>
                                                            <a href='" . URLROOT . "/mgPawnArticles/viewPawnedItem/" . $row->Article_Id . "' class='" . (($this->dateCompare($row->End_Date, 0)) ? '' : (($this->dateCompare($row->End_Date, 14)) ? 'passEndDate' : 'passRedeemedDate')) . "'>View</a>
