        ...
        <form action="<?php echo URLROOT ?>/appointments/loadTimeSlots" method="POST" class="addForm">
            ...
            <div class="form-input">
                ...
                <select name="reason" id="Reason" class="input">
                    <option class="input" value="1" <?php echo($data['reasonID']==1)? 'selected':''?>>Pawn Article
                    </option>
                    <option class="input" value="2" <?php echo($data['reasonID']==2)? 'selected':''?>>Make payment
                    </option>
                    <option class="input" value="3" <?php echo($data['reasonID']==3)? 'selected':''?>>Reserve Locker
                    </option>
                    <option class="input" value="4" <?php echo($data['reasonID']==4)? 'selected':''?>>Renew pawning
                    </option>
                    <option class="input" value="5" <?php echo($data['reasonID']==5)? 'selected':''?>>Retrieve article
                    </option>
            ...
            <div>
                ...
                <button id="submit" name="submit"
                    class="<?php echo(!empty($data['time_slot_err']))? 'none':'button submit'?>"
                    value="">Submit</button>
            </div>
