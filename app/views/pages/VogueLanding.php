  ...
  <!-- <img class="logo 100" src="<?php echo URLROOT ?>/img/sanda-01.png"> -->
    ...
    <section id="services" class="section-services">
        ...
        <div class="service-info">
            ...
            <div>
                <div class="card">
                    <img src="<?php echo URLROOT ?>/img/dmitry-demidko-eBWzFKahEaU-unsplash.jpg" alt=""
                        class="service-pic">
            ...
            <div>
                <div class="card">
                    <img src="<?php echo URLROOT ?>/img/scottsdale-mint-IYg1hjCO5DA-unsplash.jpg" alt=""
                        class="service-pic">
                    <p class="header-service">
            ...
            <div>
                <div class="card">
                    <img src="<?php echo URLROOT ?>/img/vaibhav-nagare-vv2vIFeNEMg-unsplash.jpg" alt=""
                        class="service-pic">
                    <p class="header-service">
                ...
                <div class="projcard-innerbox">
                    ...
                    <div class="projcard-textbox">
                        ...
                        <div class="projcard-description"><b>S</b>pecializes in buying gold at the best market price;
                            with our expertisise we are able to value and make the whole process of selling gold
                            transparent. </div>
                ...
                <div class="projcard-innerbox">
                    ...
                    <div class="projcard-textbox">
                        ...
                        <div class="projcard-description">
                            <b>A</b>nxious about the security of your gold? Worry no further. Within our vaults we you
                            provide the best security for your gold assets.
                        </div>
