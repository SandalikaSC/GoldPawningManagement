                        ...
                        <section class="big-form">
                            ...
                            <div class="form-group-with-err">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $data[1][0]->First_Name ?>" name="fName" id="fName" maxlength="20" title="First letter should be uppercase letter">
                                </div>
                                <div class="err">
                            ...
                            <div class="form-group-with-err">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $data[1][0]->Last_Name ?>" name="lName" id="lName" maxlength="20" title="First letter should be uppercase letter">
                                </div>
                                <div class="err">
                            ...
                            <div class="form-group-with-err">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $data[1][0]->Line1 ?>" name="lane1" id="lane1" maxlength="50">
                                </div>
                                <div class="err">
                            ...
                            <div class="form-group-with-err">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php if ($data[1][0]->Line2 == null) {
                                                                    ...
                                                                    echo $data[1][0]->Line2;
                                                                } ?>" name="lane2" id="lane2" maxlength="50" title="First letter should be uppercase letter">
                                </div>
                                <div class="err">
                            ...
                            <div class="form-group-with-err">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php if (!empty($data[1][0]->Line3)) {
                                                                    ...
                                                                    echo "";
                                                                } ?>" name="lane3" id="lane3" title="First letter should be uppercase letter" maxlength="20">
                                </div>
                                <div class="err">
...
<script>
    ...
    function validateForm() {
        ...
        const addressRegex2 = /^[A-Z][a-z]{1,200}$/;
