        ...
        <div class="right">
            <div class="right-heading">
                <div class="right-side">
                    ...
                    <h1>
                        Viewing Article: <i class='<?php echo ($this->dateCompare($data[0]->End_Date, 0) and $data[0]->WarningTwo == 0) ? "" : (($this->dateCompare($data[0]->End_Date, 14) and $data[0]->Status == "Pawned") ? "green-id" :"red-id")?>' ><?php echo $data[0]->Article_Id ?></i>
                    </h1>
                </div>
                        ...
                        <div class="bottom-box-of-right-box">
                            ...
                            <div class="amount-and-due-date">
                                ...
                                <div class="data-field">
                                    ...
                                    <div class="value"><?php if (!empty($data[0]->End_Date)) echo $data[0]->End_Date; else echo "Not Available"; ?></div>
                                </div>
                            </div>
