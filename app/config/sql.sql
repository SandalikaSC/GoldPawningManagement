...
(1, 18, '72000.00', '2022-12-17 17:09:34'),
(2, 19, '77000.00', '2022-12-17 17:09:34'),
(3, 20, '80000.00', '2022-12-17 17:09:34'),
(4, 21, '83000.00', '2022-12-17 17:09:34'),
(5, 22, '87000.00', '2022-12-17 17:09:34'),
(6, 24, '100000.00', '2022-12-17 17:09:34');
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_1` FOREIGN KEY (`Reason_ID`) REFERENCES `reason` (`Reason_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `appointment_ibfk_2` FOREIGN KEY (`slot_Id`) REFERENCES `time_slot` (`slot_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `appointment_ibfk_3` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserId`) ON DELETE CASCADE ON UPDATE CASCADE;
